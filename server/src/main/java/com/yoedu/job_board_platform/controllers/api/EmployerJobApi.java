...
public interface EmployerJobApi {
    ...
    ResponseEntity<?> getMyJobs(
            @Parameter(description = "Lọc theo trạng thái: DRAFT, PENDING_APPROVAL, ACTIVE, EXPIRED, REJECTED", example = "ACTIVE") String status,
    ...
    ResponseEntity<?> getJobDetail(
            @Parameter(description = "ID của tin tuyển dụng", example = "1", required = true) Long id);
    ...
    ResponseEntity<?> updateJob(
            @Parameter(description = "ID của tin tuyển dụng cần cập nhật", example = "1", required = true) Long id);
    ...
    ResponseEntity<?> toggleJobStatus(
            @Parameter(description = "ID của tin tuyển dụng", example = "1", required = true) Long id);
    ...
    ResponseEntity<?> updateMyCompany();
    ...
    ResponseEntity<?> getEmployerDashboard();
}

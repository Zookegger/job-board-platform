...
public class ProfileController {
    ...
    public ResponseEntity<CandidateProfileResponse> updateCandidateProfile(@Valid @RequestBody CandidateProfileRequest request) {
    ...
    public ResponseEntity<EmployerProfileResponse> updateEmployerProfile(@Valid @RequestBody EmployerProfileRequest request) {

		...
		>
			...
			>
				...
				<div className='grid grid-cols-1 not-md:grid-rows-[auto_1fr] flex-1 gap-0 md:grid-cols-[auto_1fr] '>
					{/* Left: Profile info */}
					<div className='flex md:flex-col flex-row gap-5 border-b not-md:mb-4 px-4 pb-4 md:border-r'>
					...
					{/* Right: Tabs */}
					<div className='flex flex-1 h-full flex-col px-4 pb-4 overflow-y-auto'>
						<Tabs
							defaultValue='cv'

...
import type { EmployerApplicationParams } from "@/types/application";
import { keepPreviousData, useMutation, useQuery, useQueryClient } from "@tanstack/react-query";

export const EMPLOYER_APPLICATION_KEY = {
	lists: () => ["employer", "applications"] as const,
	list: (params: EmployerApplicationParams) => ["employer", "applications", "list", params] as const,
};

export function useEmployerApplications(params: EmployerApplicationParams) {
	return useQuery({
